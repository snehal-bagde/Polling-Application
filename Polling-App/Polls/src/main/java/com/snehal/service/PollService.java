...
import com.snehal.exception.BadRequestException;
import com.snehal.exception.ResourceNotFoundException;
import com.snehal.model.Choice;
import com.snehal.model.ChoiceVoteCount;
import com.snehal.model.Poll;
import com.snehal.model.User;
import com.snehal.model.Vote;
import com.snehal.payload.PagedResponse;
import com.snehal.payload.PollRequest;
import com.snehal.payload.PollResponse;
import com.snehal.payload.VoteRequest;
import com.snehal.repository.PollRepository;
import com.snehal.repository.UserRepository;
import com.snehal.repository.VoteRepository;
import com.snehal.security.UserPrincipal;
import com.snehal.util.AppConstants;
import com.snehal.util.ModelMapper;
...
public class PollService {
	...
	public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int page, int size) {
		...
		if (polls.getNumberOfElements() == 0) {
			return new PagedResponse<PollResponse>(Collections.emptyList(), polls.getNumber(), polls.getSize(),
	...
	public PagedResponse<PollResponse> getPollsVotedBy(String username, UserPrincipal currentUser, int page, int size){
		...
		if (userVotedPollIds.getNumberOfElements() == 0) {
			return new PagedResponse<PollResponse>(Collections.emptyList(), userVotedPollIds.getNumber(), userVotedPollIds.getSize(), userVotedPollIds.getTotalElements(), userVotedPollIds.getTotalPages(), userVotedPollIds.isLast());
		}
	...
	private void validatePageNumberAndSize(int page, int size) {
		...
		if (size > AppConstants.MAX_PAGE_SIZE) {
			throw new BadRequestException("Page size must not be Greatger than : " + AppConstants.MAX_PAGE_SIZE);
		}
	}
}
